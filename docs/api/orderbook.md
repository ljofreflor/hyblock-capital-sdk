...
La `OrderbookApi` proporciona acceso a orderbook api de Hyblock Capital.

## Configuración

```python
from hyblock_capital_sdk.api import OrderbookApi
...
orderbook_api = OrderbookApi(api_client)
```

## Referencia de la API

::: hyblock_capital_sdk.api.orderbook_api
    options:
      show_source: true
...
try:
    ...
    result = orderbook_api.some_method()
