...
class HyblockClient:
        ...
        try:
            ...
            if e.error_code == 'INSUFFICIENT_FUNDS':
                raise HyblockInsufficientFundsError(
                    "Fondos insuficientes para crear la orden",
                    details=e.details
                )
    ...
    def get_ticker(self, symbol: str) -> Ticker:
        ...
        """
        try:
            data = self._make_request('GET', f'/api/v1/ticker/{symbol}', auth_required=False)
            return Ticker(**data)
        except HyblockAPIError as e:
    ...
    def get_orderbook(self, symbol: str, limit: int = 100) -> OrderBook:
        ...
        try:
            params = {'limit': limit}
            data = self._make_request('GET', f'/api/v1/orderbook/{symbol}', params=params, auth_required=False)
    ...
    def get_candles(
        ...
        try:
            ...
            data = self._make_request('GET', f'/api/v1/candles/{symbol}', params=params, auth_required=False)
    ...
    def get_market(self, symbol: str) -> MarketInfo:
        ...
        """
        try:
            data = self._make_request('GET', f'/api/v1/markets/{symbol}', auth_required=False)
